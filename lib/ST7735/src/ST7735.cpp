...
scrseg_struct        bluetft_tftdata[TFTSECS] =             // Screen divided in 4 segments + 1 overlay
                      {                                     // One text line is 8 pixels
  { false, GRAY,   1,   0, 12, 1*24, "" },                            // 1 top line
  { false, CYAN,   2,  16, 38, 2*14, "" },                            // 2 big lines in the middle - artist
  { false, YELLOW, 2,  58, 38, 2*14, "" },                            // 2 big lines in the middle - song title
  { false, RED,    1, 100, 26, 3*24, "" },                            // 4 lines at the bottom minus volume bar
